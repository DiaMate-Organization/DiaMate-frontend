...
export const assessmentSchema = Joi.object({
  ...
  Stroke: Joi.number().integer().min(0).max(1).required().messages({
    "number.base": "Riwayat stroke harus berupa pilihan valid",
    "number.min": "Riwayat stroke harus 'Ya' atau 'Tidak'",
    "number.max": "Riwayat stroke harus 'Ya' atau 'Tidak'",
    "any.required": "Riwayat stroke wajib diisi",
  }),
  HeartDiseaseorAttack: Joi.number().integer().min(0).max(1).required().messages({
  ...
  PhysActivity: Joi.number().integer().min(0).max(1).required().messages({
    "number.base": "Aktivitas fisik harus berupa pilihan valid",
    "number.min": "Aktivitas fisik harus 'Ya' atau 'Tidak'",
    "number.max": "Aktivitas fisik harus 'Ya' atau 'Tidak'",
    "any.required": "Aktivitas fisik wajib diisi",
  }),
  HvyAlcoholConsump: Joi.number().integer().min(0).max(1).required().messages({
    "number.base": "Konsumsi alkohol harus berupa pilihan valid",
    "number.min": "Konsumsi alkohol harus 'Ya' atau 'Tidak'",
    "number.max": "Konsumsi alkohol harus 'Ya' atau 'Tidak'",
    "any.required": "Konsumsi alkohol wajib diisi",
  }),
  AnyHealthcare: Joi.number().integer().min(0).max(1).required().messages({
    "number.base": "Akses layanan kesehatan harus berupa pilihan valid",
    "number.min": "Akses layanan kesehatan harus 'Ya' atau 'Tidak'",
    "number.max": "Akses layanan kesehatan harus 'Ya' atau 'Tidak'",
    "any.required": "Akses layanan kesehatan wajib diisi",
  }),
  ...
  Sex: Joi.number().integer().min(0).max(1).required().messages({
    "number.base": "Jenis kelamin harus berupa pilihan valid",
    "number.min": "Jenis kelamin harus Perempuan atau Laki-laki",
    "number.max": "Jenis kelamin harus Perempuan atau Laki-laki",
  ...
  Income: Joi.number().integer().min(1).max(8).required().messages({
